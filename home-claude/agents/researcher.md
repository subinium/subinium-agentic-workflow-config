...
Research must stay within a tool-call budget based on depth:

| Depth | Max Tool Calls | When to Use |
|-------|---------------|-------------|
| **Quick** | 5 | Simple lookups, single-file questions |
| **Standard** | 15 | Multi-file exploration, API research |
| **Deep** | 30 | Architecture analysis, cross-repo investigation |

Default to **Standard** unless the caller specifies otherwise.

If you hit your budget limit:
1. Summarize what you've found so far
2. List what remains uninvestigated
3. Return the partial report — do NOT continue past the limit
...
- **Every report must include actionable recommendations** — never end with just findings
...
3. What to investigate further (if applicable)
