...
2. `.github/dependabot.yml` — weekly dependency updates
...
### Next Steps
1. `git add .github/ && git commit -m "ci: add GitHub Actions pipeline"`
2. Push to trigger first run
3. Add branch protection rule requiring CI to pass
```
